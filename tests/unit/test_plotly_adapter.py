...
def test_plotly_adapter_formatting():
    ...
    airports = [
        Airport(id=1, name="El Dorado", iata_code="BOG", city="Bogotá", department="Cundinamarca", latitude=4.7016, longitude=-74.1469, type="Internacional"),
        Airport(id=5, name="José María Córdova", iata_code="MDE", city="Medellín", department="Antioquia", latitude=6.1645, longitude=-75.4231, type="Internacional"),
        Airport(id=99, name="Sin Coordenadas", iata_code="XXX", city="Ciudad", department="Depto", latitude=0.0, longitude=0.0, type="Nacional")
    ]
