...
class GetAirportByIdUseCase:
    ...
    def __init__(self, external_port: ExternalAirportPort, list_use_case: Optional[ListAirportsUseCase] = None):
        self._external_port = external_port
        self._list_use_case = list_use_case

    async def execute(self, airport_id: int) -> Optional[Airport]:
