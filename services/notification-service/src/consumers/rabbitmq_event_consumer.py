...
class RabbitMQEventConsumer:
    ...
    def __init__(
        ...
        notification_func: Optional[SendNotificationFunction] = None
    ):
    ...
    async def start(self):
        ...
        while self._is_running:
            try:
                ...
                logger.info(f"Consumer bound to queue '{self.queue_name}'. Waiting for events...")
                    ...
                    async for message in queue_iter:
                        ...
                        async with message.process():
                            try:
                                ...
                                trace_id = message.headers.get("trace_id", payload.get("trace_id", ""))
                ...
                logger.warning(f"RabbitMQ connection error in consumer: {conn_err}. Retrying in 5 seconds...")
